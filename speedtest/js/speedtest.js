...
const serverAddress = 'https://krasnij.mitwhiz.com:8096';
...
$(document).ready(function () {
  ...
  let setupMode = (localName, remoteName) => {
    return () => {
      p2p.allowedRemoteIds = [remoteName];
      p2p
        .connect({
          host: serverAddress,
          token: localName
  ...
  $('#server').click(setupMode('speedServer', 'speedClient'));
  $('#client').click(setupMode('speedClient', 'speedServer'));
